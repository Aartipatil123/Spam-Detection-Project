...
button1 = tk.Button(frame,command=Data_Display,text="Data_Display",bg="#cce6ff",fg="black",width=15,font=("Times New Roman",15,"bold"))
...
button3 = tk.Button(frame,command=Test,text="Test",bg="#cce6ff",fg="black",width=15,font=("Times New Roman",15,"bold"))
